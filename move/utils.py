...
class UrdfKinematics:
    ...
    def __init__(self, urdf_path: Path):
        ...
        self._origin_cache: Dict[str, np.ndarray] = {}
        ...
        for joint in root.findall("joint"):
            ...
            self._origin_cache[child] = self._transform(self._rpy_to_rot(rpy), xyz)
    ...
    def _chain_to(self, link: str) -> List[JointInfo]:
        cached = self._chain_cache.get(link)
        ...
        while link in self.joints_by_child:
            ...
            link = joint.parent
        chain.reverse()
        self._chain_cache[original_link] = chain
        return chain
    ...
    def fk(self, link: str, q_map: Dict[str, float]) -> np.ndarray:
        ...
        for joint in self._chain_to(link):
            mat = mat @ self._origin_cache[joint.child]
